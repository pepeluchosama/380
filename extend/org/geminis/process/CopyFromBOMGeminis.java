 ...
 */
public class CopyFromBOMGeminis extends SvrProcess {
	/**					*/
	...
	protected String doIt() throws Exception
	{
		...
		for (MPPProductBOMLine frombomline : frombomlines)
		{
			...
			//se copian valores de geminis
			if(frombomline.get_Value("Floor") != null)
				tobomline.set_CustomColumn("Floor", (BigDecimal)frombomline.get_Value("Floor"));
			if(frombomline.get_Value("TotalColumns") != null)
				tobomline.set_CustomColumn("TotalColumns", (BigDecimal)frombomline.get_Value("TotalColumns"));
			if(frombomline.get_Value("TotalRows") != null)
				tobomline.set_CustomColumn("TotalRows", (BigDecimal)frombomline.get_Value("TotalRows"));
			if(frombomline.get_Value("AisleColumn") != null)
				tobomline.set_CustomColumn("AisleColumn", (BigDecimal)frombomline.get_Value("AisleColumn"));
			tobomline.save();
			++no;
		}
