 ...
 */
public class DeleteAcctVoidedInvoice extends SvrProcess
{	
	/**
	...
	protected String doIt() throws AdempiereSystemError
	{
		...
		String sqlDelete = "DELETE from Fact_acct where AD_Table_ID = 318 and Record_ID IN "+ 
				"( select C_Invoice_id   from c_invoice ci   where docstatus in ('VO'))";
		try
		{
