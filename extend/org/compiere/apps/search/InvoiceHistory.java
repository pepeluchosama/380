	...
	implements ActionListener, ChangeListener
{
	...
	private void initReservedOrderedTab (boolean reserved)
	{
		...
		if (m_C_BPartner_ID == 0)
		{
			//ininoles se reemplaza precio por 0 
			String sql =  "";
			if(OFBForward.NewSQLBtnHistory())
				sql = "SELECT bp.Name, 0 as PriceActual, ol.PriceList,ol.QtyReserved,";
			else	
				sql = "SELECT bp.Name, ol.PriceActual,ol.PriceList,ol.QtyReserved,";
			
			sql = sql+"o.DateOrdered,dt.PrintName || ' ' || o.DocumentNo As DocumentNo, "
				+ "w.Name,"
