 ...
 * 
 */
public class VInvoiceGenOFBUnConsolidate extends InvoiceGenUnConsolidate implements FormPanel, ActionListener, VetoableChangeListener
{
	...
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(VInvoiceGenOFBUnConsolidate.class);
	//
