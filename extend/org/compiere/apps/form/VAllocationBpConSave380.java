 ...
 */
public class VAllocationBpConSave380 extends AllocationBL360
...
//		columnNames.add(" ");	//	Multiplier
		...
		//paymentTable.setColumnClass(i, IDColumn.class, true);         //  0-Selection
...
//		columnNames.add(" ");	//	Multiplier
		...
		//invoiceTable.setColumnClass(i, IDColumn.class, true);        //  0-C_Invoice_ID
...
//		i_multiplier = multiCurrency.isSelected() ? 10 : 8;
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (e.getSource().equals(allocateButton))
		{
			...
			saveData(m_WindowNo,dateField.getValue(),paymentTable, invoiceTable, multiCurrency.isSelected());
			loadBPartner();
	...
	public String saveData(int m_WindowNo, Object date, IMiniTable payment, IMiniTable invoice, boolean multiCurrency)
	{
		if (m_noInvoices + m_noPayments == 0)
			return "";
