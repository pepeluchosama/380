 ...
 */
public class VMPRequestOTGeminis extends CPanel
	implements FormPanel, ActionListener, TableModelListener, VetoableChangeListener, ASyncProcess
{
	...
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(VMPRequestOTGeminis.class);
	...
	//ininoles nuevo campo tipo
	private JLabel typeLabel = new JLabel();
	private VComboBox  typeCmb = new VComboBox();
...
//				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 0, 5, 5), 0, 0));
			...
			parameterPanel.add(selectall, new GridBagConstraints(5, 0, 1, 1, 0.0, 0.0
					,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
			parameterPanel.add(typeLabel, new GridBagConstraints(6, 0, 1, 1, 0.0, 0.0
					,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
			parameterPanel.add(typeCmb, new GridBagConstraints(7, 0, 1, 1, 0.0, 0.0
					,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
			
			parameterPanel.add(jobLabel, new GridBagConstraints(8, 0, 1, 1, 0.0, 0.0
					,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
			parameterPanel.add(jobSearch, new GridBagConstraints(9, 0, 1, 1, 0.0, 0.0
					,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
			parameterPanel.add(jobButton, new GridBagConstraints(10, 0, 1, 1, 0.0, 0.0
					,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
	...
	// jobstandard
		...
		// nuevo filtro tipo
		typeLabel.setText(Msg.translate(Env.getCtx(), "Tipo de Servicio "));
		typeCmb.addItem(new KeyNamePair(0,"--"));
		typeCmb.addItem(new KeyNamePair(1,"Preventiva"));
		typeCmb.addItem(new KeyNamePair(2,"Correctiva"));
	...
	{		
		...
		KeyNamePair typeKNPair = (KeyNamePair)typeCmb.getSelectedItem();
		if(typeKNPair != null && typeKNPair.getKey() > 0)
		{
			String valueType = "";
			if(typeKNPair.getKey() == 1)
				valueType = "MP";
			else if(typeKNPair.getKey() == 2)
				valueType = "RP";
			if(valueType != null && valueType.length() > 1)
				sql.append(" and rt.OT_Request_Type ='"+valueType+"'");
		}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (e.getSource().equals(typeCmb))
		{
			loadMPs();
		}
	}   //  actionPerformed
