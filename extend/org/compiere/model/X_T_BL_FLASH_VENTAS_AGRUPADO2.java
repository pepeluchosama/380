...
/** Generated Model for T_BL_FLASH_VENTAS_AGRUPADO2
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_T_BL_FLASH_VENTAS_AGRUPADO2 extends PO implements I_T_BL_FLASH_VENTAS_AGRUPADO2, I_Persistent 
{
    ...
    public X_T_BL_FLASH_VENTAS_AGRUPADO2 (Properties ctx, int T_BL_FLASH_VENTAS_AGRUPADO2_ID, String trxName)
    {
      super (ctx, T_BL_FLASH_VENTAS_AGRUPADO2_ID, trxName);
      /** if (T_BL_FLASH_VENTAS_AGRUPADO2_ID == 0)
        {
			setT_BL_FLASH_VENTAS_AGRUPADO2_ID (0);
        } */
    }

    /** Load Constructor */
    public X_T_BL_FLASH_VENTAS_AGRUPADO2 (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_T_BL_FLASH_VENTAS_AGRUPADO2[")
	...
	/** Set T_BL_FLASH_VENTAS_AGRUPADO2.
		@param T_BL_FLASH_VENTAS_AGRUPADO2_ID T_BL_FLASH_VENTAS_AGRUPADO2	  */
	public void setT_BL_FLASH_VENTAS_AGRUPADO2_ID (int T_BL_FLASH_VENTAS_AGRUPADO2_ID)
	{
		if (T_BL_FLASH_VENTAS_AGRUPADO2_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_T_BL_FLASH_VENTAS_AGRUPADO2_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_T_BL_FLASH_VENTAS_AGRUPADO2_ID, Integer.valueOf(T_BL_FLASH_VENTAS_AGRUPADO2_ID));
	}

	/** Get T_BL_FLASH_VENTAS_AGRUPADO2.
		@return T_BL_FLASH_VENTAS_AGRUPADO2	  */
	public int getT_BL_FLASH_VENTAS_AGRUPADO2_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_T_BL_FLASH_VENTAS_AGRUPADO2_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
