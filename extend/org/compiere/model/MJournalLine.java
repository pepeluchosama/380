...
public class MJournalLine extends X_GL_JournalLine
{
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		// idempiere 344 - nmicoud // ininoles se comenta codigo
		...
		//fillDimensionsFromCombination(); // ininoles 
		//	Acct Amts
	...
	private boolean updateJournalTotal()
	{
		...
		//	Update Batch Total
		//ininoles por urgencia en minsal y necesidad de rendimiento no se actualizara batch
	...
	private void fillDimensionsFromCombination()
	{
		if (getC_ValidCombination_ID() > 0)
		{
			...
			//ininoles se cambia nulo por 0 para poder usar procesos de activos.
