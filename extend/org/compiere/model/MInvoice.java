	...
	public String completeIt()
	{
		...
		for (int i = 0; i < lines.length; i++)
		{
			...
			if (line.getC_OrderLine_ID() != 0)
			{
				...
				{
					//ininoles no se actualizara orden si es una nota de credito ARTILEC
					if(getC_DocType().getDocBaseType().compareTo("ARC") != 0)
					{
...
//		MOrgInfo counterOrgInfo = MOrgInfo.get(getCtx(), counterAD_Org_ID);
	...
	public boolean reverseCorrectIt()
	{
		...
		/**
		 * @mfrojas
		 * Se comenta código para generar el reverso, tal como en 360 (Implementado por @faaguilar)
		 * 
		 * **/
		 ...
		 * segun esquema OFB (implementado por faaguilar) */
	...
	//ininoles nuevos metodos para contabilidad de asignacion 
