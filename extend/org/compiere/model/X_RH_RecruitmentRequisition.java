...
/** Generated Model for RH_RecruitmentRequisition
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_RH_RecruitmentRequisition extends PO implements I_RH_RecruitmentRequisition, I_Persistent 
{
    ...
    public X_RH_RecruitmentRequisition (Properties ctx, int RH_RecruitmentRequisition_ID, String trxName)
    {
      super (ctx, RH_RecruitmentRequisition_ID, trxName);
      /** if (RH_RecruitmentRequisition_ID == 0)
        {
			setDocStatus (null);
// DR
			setName (null);
			setProcessed (false);
			setRH_RecruitmentRequisition_ID (0);
        } */
    }

    /** Load Constructor */
    public X_RH_RecruitmentRequisition (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_RH_RecruitmentRequisition[")
