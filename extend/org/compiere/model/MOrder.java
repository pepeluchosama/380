...
public class MOrder extends X_C_Order implements DocAction
{
	...
	public String completeIt()
	{
		...
		/*
		 * PARA ARTILEC:
		 * SE SETEA VARIABLE BOOLEAN FLAGWS en FALSE. 
		 * SE MANTIENE EN FALSE SI NO HAY OFBFORWARD, POR LO QUE CONTINUA EL PROCESO NORMAL.
		 * SI ES TRUE, NO GENERA SHIPMENT (ES TRUE SOLO SI LA ORDEN ES GENERADA POR WS.
		 * */
