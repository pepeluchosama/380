...
/** Generated Model for DM_MandateAgreement
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_DM_MandateAgreement extends PO implements I_DM_MandateAgreement, I_Persistent 
{
    ...
    public X_DM_MandateAgreement (Properties ctx, int DM_MandateAgreement_ID, String trxName)
    {
      super (ctx, DM_MandateAgreement_ID, trxName);
      /** if (DM_MandateAgreement_ID == 0)
        {
...
// DR
    ...
    /** Load Constructor */
    public X_DM_MandateAgreement (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_DM_MandateAgreement[")
