...
/** Generated Model for MP_JobStandar_Task
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_MP_JobStandar_Task extends PO implements I_MP_JobStandar_Task, I_Persistent 
{
    ...
    public X_MP_JobStandar_Task (Properties ctx, int MP_JobStandar_Task_ID, String trxName)
    {
      super (ctx, MP_JobStandar_Task_ID, trxName);
      /** if (MP_JobStandar_Task_ID == 0)
        {
			setC_UOM_ID (0);
    ...
    /** Load Constructor */
    public X_MP_JobStandar_Task (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_MP_JobStandar_Task[")
