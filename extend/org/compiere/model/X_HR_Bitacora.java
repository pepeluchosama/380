...
/** Generated Model for HR_Bitacora
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_HR_Bitacora extends PO implements I_HR_Bitacora, I_Persistent 
{
    ...
    public X_HR_Bitacora (Properties ctx, int HR_Bitacora_ID, String trxName)
    {
      super (ctx, HR_Bitacora_ID, trxName);
      /** if (HR_Bitacora_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_HR_Bitacora (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_Bitacora[")
	...
	{
		if (HR_Bitacora_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_HR_Bitacora_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_HR_Bitacora_ID, Integer.valueOf(HR_Bitacora_ID));
	}
