...
/** Generated Model for CC_Isapre
 *  @author Adempiere (generated) 
 *  @version Release 3.8.0 - $Id$ */
public class X_CC_Isapre extends PO implements I_CC_Isapre, I_Persistent 
{
    ...
    public X_CC_Isapre (Properties ctx, int CC_Isapre_ID, String trxName)
    {
      super (ctx, CC_Isapre_ID, trxName);
      /** if (CC_Isapre_ID == 0)
        {
			setCC_Isapre_ID (0);
        } */
    ...
    /** Load Constructor */
    public X_CC_Isapre (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_CC_Isapre[")
	...
	{
		if (CC_Isapre_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_CC_Isapre_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_CC_Isapre_ID, Integer.valueOf(CC_Isapre_ID));
	}
