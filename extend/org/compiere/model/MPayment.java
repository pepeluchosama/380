...
*/
	...
	public String prepareIt()
	{
		...
		//ininoles se saca validacion para asignacion internacional
...
*/
	...
	public boolean voidIt()
	{
		...
		{
			//faaguilar OFB antes de anular begin
			if(!voidCashBook())
			{
				return false;
			}//faaguilar end
	...
	public boolean reverseCorrectIt()
	{
		...
		/**ininoles OFB codigo comentado creacion de pago inverso begin implementado en 360 por @faaguilar*/
		//	Create Reversal
		...
		*/
		/**ininoles OFB codigo comentado creacion de pago inverso end*/
		...
		//	Set Status 
		//addDescription("(" + reversal.getDocumentNo() + "<-)"); //ininoles ya no existe reverso
		setDocStatus(DOCSTATUS_Reversed);
		setDocAction(DOCACTION_None);
		setPayAmt(Env.ZERO);
		setProcessed(true);
		//FR [ 1948157  ] 
		//setReversal_ID(reversal.getC_Payment_ID()); //ininoles ya no existe reverso
		
		/**ininoles OFB codigo comentado creacion de allocation pago inverso begin implementado por @faaguilar*/
		...
		*/
		/**ininoles OFB codigo comentado creacion de allocation pago inverso end*/
		//	Update BPartner
