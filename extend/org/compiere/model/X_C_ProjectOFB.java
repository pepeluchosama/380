...
/** Generated Model for C_ProjectOFB
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_C_ProjectOFB extends PO implements I_C_ProjectOFB, I_Persistent 
{
    ...
    public X_C_ProjectOFB (Properties ctx, int C_ProjectOFB_ID, String trxName)
    {
      super (ctx, C_ProjectOFB_ID, trxName);
      /** if (C_ProjectOFB_ID == 0)
        {
			setC_ProjectOFB_ID (0);
			setValue (null);
        } */
    }

    /** Load Constructor */
    public X_C_ProjectOFB (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_ProjectOFB[")
	...
	/** Set G_RealStartDate.
		@param G_RealStartDate 
		The real  date of this document.
	  */
	public void setG_RealStartDate (Timestamp G_RealStartDate)
	{
		set_Value (COLUMNNAME_G_RealStartDate, G_RealStartDate);
	}

	/** Get G_RealStartDate.
		@return The real  date of this document.
	  */
	public Timestamp getG_RealStartDate () 
	{
		return (Timestamp)get_Value(COLUMNNAME_G_RealStartDate);
	}
