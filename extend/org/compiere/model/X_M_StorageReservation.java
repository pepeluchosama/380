 ...
 *  @version Release 3.5.2aOFB v75RC60F - $Id$ */
public class X_M_StorageReservation extends PO implements I_M_StorageReservation, I_Persistent 
{
	...
	/** Set M_StorageReservation.
		@param M_StorageReservation_ID M_StorageReservation	  */
	public void setM_StorageReservation_ID (int M_StorageReservation_ID)
	{
		if (M_StorageReservation_ID < 1)
			 throw new IllegalArgumentException ("M_StorageReservation_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_M_StorageReservation_ID, Integer.valueOf(M_StorageReservation_ID));
	}

	/** Get M_StorageReservation.
		@return M_StorageReservation	  */
	public int getM_StorageReservation_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_M_StorageReservation_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
