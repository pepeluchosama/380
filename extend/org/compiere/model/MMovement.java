					...
					&& product.isStocked() )
			{
				...
				if (line.getM_AttributeSetInstance_ID() == 0)
				{
					...
					for (int j = 0; j < mas.length; j++)
					{
						...
						//ininoles se cambia org del locator por org de linea
						...
						//MTransaction trxTo = new MTransaction (getCtx(), locatorTo.getAD_Org_ID(), // ininoles
				...
				if (trxFrom == null)
				{
					...
					//ininoles no se reemplazara organizacion por la de la ubicación
					//MLocator locatorTo = new MLocator (getCtx(), line.getM_LocatorTo_ID(), get_TrxName());
					MTransaction trxTo = new MTransaction (getCtx(), line.getAD_Org_ID(), 
							MTransaction.MOVEMENTTYPE_MovementTo,
