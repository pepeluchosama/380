...
/** Generated Model for TP_CommissionTSM
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_TP_CommissionTSM extends PO implements I_TP_CommissionTSM, I_Persistent 
{
    ...
    public X_TP_CommissionTSM (Properties ctx, int TP_CommissionTSM_ID, String trxName)
    {
      super (ctx, TP_CommissionTSM_ID, trxName);
      /** if (TP_CommissionTSM_ID == 0)
        {
			setTP_CommissionTSM_ID (0);
        } */
    }

    /** Load Constructor */
    public X_TP_CommissionTSM (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TP_CommissionTSM[")
