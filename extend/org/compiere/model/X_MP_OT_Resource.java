...
/** Generated Model for MP_OT_Resource
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_MP_OT_Resource extends PO implements I_MP_OT_Resource, I_Persistent 
{
    ...
    public X_MP_OT_Resource (Properties ctx, int MP_OT_Resource_ID, String trxName)
    {
      super (ctx, MP_OT_Resource_ID, trxName);
      /** if (MP_OT_Resource_ID == 0)
        {
			setMP_OT_Resource_ID (0);
			setMP_OT_Task_ID (0);
			setProcessed (false);
        } */
    }
    ...
    /** Load Constructor */
    public X_MP_OT_Resource (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_MP_OT_Resource[")
	...
	/** Set MP_OT_Resource.
		@param MP_OT_Resource_ID MP_OT_Resource	  */
	public void setMP_OT_Resource_ID (int MP_OT_Resource_ID)
	{
		if (MP_OT_Resource_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_MP_OT_Resource_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_MP_OT_Resource_ID, Integer.valueOf(MP_OT_Resource_ID));
	}

	/** Get MP_OT_Resource.
		@return MP_OT_Resource	  */
	public int getMP_OT_Resource_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_MP_OT_Resource_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
