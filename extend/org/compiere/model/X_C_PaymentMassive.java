...
/** Generated Model for C_PaymentMassive
 *  @author Adempiere (generated) 
 *  @version Release 3.5.2aOFB v60 - $Id$ */
public class X_C_PaymentMassive extends PO implements I_C_PaymentMassive, I_Persistent 
{
    ...
    public X_C_PaymentMassive (Properties ctx, int C_PaymentMassive_ID, String trxName)
    {
      super (ctx, C_PaymentMassive_ID, trxName);
      /** if (C_PaymentMassive_ID == 0)
        {
...
// N
    ...
    /** Load Constructor */
    public X_C_PaymentMassive (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_PaymentMassive[")
	...
	public void setTenderType (String TenderType)
	{
		...
		if (TenderType.equals("C") || TenderType.equals("K") || TenderType.equals("A") || TenderType.equals("D") || TenderType.equals("T") || TenderType.equals("Z") || TenderType.equals("P") || TenderType.equals("V")); else throw new IllegalArgumentException ("TenderType Invalid value - " + TenderType + " - Reference_ID=214 - C - K - A - D - T - Z - P - V");		set_Value (COLUMNNAME_TenderType, TenderType);
	}
	...
	public  X_C_PaymentMassiveLine[] getLines ()
	{
		ArrayList< X_C_PaymentMassiveLine> list = new ArrayList< X_C_PaymentMassiveLine> ();
		StringBuffer sql = new StringBuffer("SELECT * FROM C_PaymentMassiveLine WHERE C_PaymentMassive_ID=? ");
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		try
		{
			pstmt = DB.prepareStatement(sql.toString(), get_TrxName());
			pstmt.setInt(1, getC_PaymentMassive_ID());
			rs = pstmt.executeQuery();
			while (rs.next())
			{
				X_C_PaymentMassiveLine ol = new X_C_PaymentMassiveLine(getCtx(), rs, get_TrxName());
				list.add(ol);
			}
 		}
		catch (Exception e)
		...
		//
		 X_C_PaymentMassiveLine[] lines = new  X_C_PaymentMassiveLine[list.size ()];
		list.toArray (lines);
		return lines;
	}
}