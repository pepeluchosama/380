...
/** Generated Model for MP_MaintainDetail
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_MP_MaintainDetail extends PO implements I_MP_MaintainDetail, I_Persistent 
{
    ...
    public X_MP_MaintainDetail (Properties ctx, int MP_MaintainDetail_ID, String trxName)
    {
      super (ctx, MP_MaintainDetail_ID, trxName);
      /** if (MP_MaintainDetail_ID == 0)
        {
			setDocStatus (null);
			setDocumentNo (null);
			setMP_Maintain_ID (0);
			setMP_MaintainDetail_ID (0);
			setProgrammingType (false);
        } */
    }

    /** Load Constructor */
    public X_MP_MaintainDetail (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_MP_MaintainDetail[")
	...
	/** Set MP_MaintainDetail.
		@param MP_MaintainDetail_ID MP_MaintainDetail	  */
	public void setMP_MaintainDetail_ID (int MP_MaintainDetail_ID)
	{
		if (MP_MaintainDetail_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_MP_MaintainDetail_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_MP_MaintainDetail_ID, Integer.valueOf(MP_MaintainDetail_ID));
	}

	/** Get MP_MaintainDetail.
		@return MP_MaintainDetail	  */
	public int getMP_MaintainDetail_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_MP_MaintainDetail_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public String isProgrammingType () 
	{
