...
/** Generated Model for T_BL_FLASH_VENTAS_DETALLE
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_T_BL_FLASH_VENTAS_DETALLE extends PO implements I_T_BL_FLASH_VENTAS_DETALLE, I_Persistent 
{
    ...
    public X_T_BL_FLASH_VENTAS_DETALLE (Properties ctx, int T_BL_FLASH_VENTAS_DETALLE_ID, String trxName)
    {
      super (ctx, T_BL_FLASH_VENTAS_DETALLE_ID, trxName);
      /** if (T_BL_FLASH_VENTAS_DETALLE_ID == 0)
        {
			setT_BL_FLASH_VENTAS_DETALLE_ID (0);
        } */
    }

    /** Load Constructor */
    public X_T_BL_FLASH_VENTAS_DETALLE (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_T_BL_FLASH_VENTAS_DETALLE[")
	...
	{
		set_ValueNoCheck (COLUMNNAME_MARGENPORC, MARGENPORC);
	}
	...
	public I_C_BPartner_Location getPLANTA() throws RuntimeException
    {
		return (I_C_BPartner_Location)MTable.get(getCtx(), I_C_BPartner_Location.Table_Name)
			.getPO(getPLANTA_ID(), get_TrxName());	}
    ...
    {
		return (I_C_BPartner)MTable.get(getCtx(), I_C_BPartner.Table_Name)
			.getPO(getREPRESENTADA_PADRE_ID(), get_TrxName());	}
	...
	/** Set T_BL_FLASH_VENTAS_DETALLE.
		@param T_BL_FLASH_VENTAS_DETALLE_ID T_BL_FLASH_VENTAS_DETALLE	  */
	public void setT_BL_FLASH_VENTAS_DETALLE_ID (int T_BL_FLASH_VENTAS_DETALLE_ID)
	{
		if (T_BL_FLASH_VENTAS_DETALLE_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_T_BL_FLASH_VENTAS_DETALLE_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_T_BL_FLASH_VENTAS_DETALLE_ID, Integer.valueOf(T_BL_FLASH_VENTAS_DETALLE_ID));
	}

	/** Get T_BL_FLASH_VENTAS_DETALLE.
		@return T_BL_FLASH_VENTAS_DETALLE	  */
	public int getT_BL_FLASH_VENTAS_DETALLE_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_T_BL_FLASH_VENTAS_DETALLE_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
