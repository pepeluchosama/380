...
/** Generated Model for MP_JobStandar_Resource
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_MP_JobStandar_Resource extends PO implements I_MP_JobStandar_Resource, I_Persistent 
{
    ...
    public X_MP_JobStandar_Resource (Properties ctx, int MP_JobStandar_Resource_ID, String trxName)
    {
      super (ctx, MP_JobStandar_Resource_ID, trxName);
      /** if (MP_JobStandar_Resource_ID == 0)
        {
			setMP_JobStandar_Resource_ID (0);
			setMP_JobStandar_Task_ID (0);
        } */
    }

    /** Load Constructor */
    public X_MP_JobStandar_Resource (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_MP_JobStandar_Resource[")
	...
	/** Set MP_JobStandar_Resource.
		@param MP_JobStandar_Resource_ID MP_JobStandar_Resource	  */
	public void setMP_JobStandar_Resource_ID (int MP_JobStandar_Resource_ID)
	{
		if (MP_JobStandar_Resource_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_MP_JobStandar_Resource_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_MP_JobStandar_Resource_ID, Integer.valueOf(MP_JobStandar_Resource_ID));
	}

	/** Get MP_JobStandar_Resource.
		@return MP_JobStandar_Resource	  */
	public int getMP_JobStandar_Resource_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_MP_JobStandar_Resource_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
    ...
    {
		return (I_MP_JobStandar_Task)MTable.get(getCtx(), I_MP_JobStandar_Task.Table_Name)
			.getPO(getMP_JobStandar_Task_ID(), get_TrxName());	}

	/** Set MP_JobStandar_Task.
		@param MP_JobStandar_Task_ID MP_JobStandar_Task	  */
	public void setMP_JobStandar_Task_ID (int MP_JobStandar_Task_ID)
	{
		if (MP_JobStandar_Task_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_MP_JobStandar_Task_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_MP_JobStandar_Task_ID, Integer.valueOf(MP_JobStandar_Task_ID));
	}

	/** Get MP_JobStandar_Task.
		@return MP_JobStandar_Task	  */
	public int getMP_JobStandar_Task_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_MP_JobStandar_Task_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
