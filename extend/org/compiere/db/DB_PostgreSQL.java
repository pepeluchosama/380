	...
	public DataSource getDataSource(CConnection connection)
	{
        ...
        try
        {
            ...
            else
            {
                ...
                cpds.setMaxPoolSize(500);  //@mfrojas se cambia el maxpoolsize
                cpds.setMaxIdleTimeExcessConnections(1200);
                cpds.setMaxIdleTime(1200);
                //m_maxbusyconnections = 120;
                m_maxbusyconnections = 500; //@mfrojas se cambia el maxbusyconnections
            }

            //the following sometimes kill active connection!
            //cpds.setUnreturnedConnectionTimeout(300); //mfrojas se descomentan estas 2 líneas
            //cpds.setDebugUnreturnedConnectionStackTraces(true);
            log.config("Conexiones en 500");
