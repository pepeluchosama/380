	...
	implements ActionListener, MouseListener, ListSelectionListener
{
	...
	private static ColumnInfo[] s_layout = new ColumnInfo[] 
	{
		...
		new ColumnInfo(Msg.translate(Env.getCtx(), "DocStatus"), "DocStatus", String.class)//faaguilar OFB
	};
	...
	public void setResults (Properties ctx, String id, String doc, Timestamp date)
	{
		...
		try 
		{
			sql = "SELECT o.C_Order_ID, o.DocumentNo, o.TotalLines, o.GrandTotal, b.Name , o.DocStatus FROM C_Order o INNER JOIN C_BPartner b ON o.C_BPartner_ID=b.C_BPartner_ID WHERE o.C_DocTypeTarget_ID = " + p_pos.getC_DocType_ID();//faaguilar OFB add , o.DocStatus
