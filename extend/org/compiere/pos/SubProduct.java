	...
	implements ActionListener, FocusListener
{
	...
	public void actionPerformed (ActionEvent e)
	{
		...
		{
			setParameter();
			p_posPanel.f_queryProduct.setResultsLevels();
	...
	/**
	 * 	Set Price for defined product whit parameter price
	 */
	public void setPrice(BigDecimal amtLine)
	{
		if (m_product == null)
			return;
		p_posPanel.f_curLine.setPrice(amtLine.multiply(new BigDecimal("1.19")));//faaguilar OFB add tax
	}	//	setPrice
