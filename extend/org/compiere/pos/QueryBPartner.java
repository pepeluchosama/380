	...
	implements ActionListener, MouseListener, ListSelectionListener
{
	...
	public void actionPerformed (ActionEvent e)
	{
			...
			)
		{
			...
			//ininoles se usa nuevo metodo para poder manipula la cantidad de datos devueltos
			setResults(findBPWhitLimit(p_ctx,
			f_value.getText(), f_name.getText(), 
			null, f_email.getText(),
			f_phone.getText(), f_city.getText(),500));
			return;
		}
	...
	public MBPartnerInfo[] findBPWhitLimit (Properties ctx, 
			String Value, String Name, String Contact, String EMail, String Phone, String City, int CLimit)
		{
			...
			//sql.append(" LIMIT ").append(CLimit);
			//
