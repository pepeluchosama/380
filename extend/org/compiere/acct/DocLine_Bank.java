...
public class DocLine_Bank extends DocLine
{
	...
	public DocLine_Bank (MBankStatementLine line, Doc_BankStatement doc)
	{
		...
		//faaguilar OFB begin
		String sql = "SELECT TenderType FROM C_Payment WHERE C_Payment_ID=?";
			
			m_TenderType = DB.getSQLValueString(null, sql, m_C_Payment_ID);
			
			sql = "SELECT isReceipt FROM C_Payment WHERE C_Payment_ID=?";
			    
			m_isReceipt =DB.getSQLValueString(null, sql, m_C_Payment_ID);
		//faaguilar OFB end
	}   //  DocLine_Bank
	...
	private String		m_isReceipt = null;
	
	public void setm_TenderType (String TenderType)
	{
		m_TenderType = TenderType;
	}
	
	public String getm_TenderType ()
	{
		return m_TenderType;
	}
	
	//
	public void setm_isReceipt (String receipt)
	{
		m_isReceipt = receipt;
	}
	 
	public String getm_isReceipt ()
	{
		return m_isReceipt;
	}
	//faaguilar OFB end
