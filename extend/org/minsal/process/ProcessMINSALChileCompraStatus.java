 ...
 *
 *	@author mfrojas
 *	@version $Id: ProcessHOSMETChileCompraStatus.java,v 1.2 2006/07/30 00:51:02 mfrojas Exp $
 */
public class ProcessMINSALChileCompraStatus extends SvrProcess
{
	/**	The Order				*/
	...
	protected String doIt() throws Exception
	{
		...
		for(int j = 0; j<orders.length; j++)
		{
			...
			log.config("docno "+docno);
			website = "http://api.mercadopublico.cl/servicios/v1/publico/ordenesdecompra.json?codigo="+docno+"&ticket="+p_Token;
			is = null;
