 ...
 *  @author ininoles
 */
public class ModUpdateStorage implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModUpdateStorage ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModUpdateStorage.class);
	/** Client			*/
	...
	public String modelChange (PO po, int type) throws Exception
	{
		...
		if((type == TYPE_AFTER_CHANGE || type == TYPE_AFTER_NEW )&& po.get_Table_ID() == MStorage.Table_ID)
		{	
