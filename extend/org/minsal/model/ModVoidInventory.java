 ...
 *  @author ininoles
 */
public class ModVoidInventory implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModVoidInventory ()
	{
		super ();
	}	//	MyValidator
	...
	public String docValidate (PO po, int timing)
	{
		...
		if((timing == TIMING_AFTER_VOID || timing == TIMING_AFTER_REVERSECORRECT )&& po.get_Table_ID()==MInventory.Table_ID)
		{
