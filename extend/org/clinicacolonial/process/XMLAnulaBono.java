 ...
 *	
 *  @author mfrojas
 *  @version $Id: XMLAnulaBono.java,v 1.2 19/05/2011 $
 */
public class XMLAnulaBono extends SvrProcess
{	
	/** Properties						*/
	...
	protected String doIt () throws Exception
	{
		...
		String msg = "";
		msg=XMLAnulaBono(hosp);		
		return msg;
	}	//	doIt
	
	public String XMLAnulaBono(X_CC_Hospitalization hosp)
    {	
		String wsRespuesta = "";
        ...
        try
        {
            ...
            Element Documento = document.createElement("urn:AnulBonInterfaz");
            ...
            if(hosp.get_Value("foliono") == null || hosp.get_Value("foliono").toString().length() < 3)
            	throw new AdempiereException("No hay nro de folio");
            ...
            Element FolioBono = document.createElement("FolioBono");
            org.w3c.dom.Text folio = document.createTextNode(hosp.get_Value("foliono").toString());
            
            FolioBono.appendChild(folio);
            Documento.appendChild(FolioBono);
            ...
            Documento.appendChild(RutCajero);
    	...
    	/*	byte[] fileArray = new byte[(int) file.length()];
    		...
    		*/
			...
			else
			{
				...
				String updatesql = "UPDATE cc_hospitalization SET copay = '"+amountcopay+"'  WHERE " +
