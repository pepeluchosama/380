 ...
 *  @author ininoles
 */
public class ModCCValidDateAdDischarge implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModCCValidDateAdDischarge ()
	{
		super ();
	}	//	MyValidator
	...
	public void initialize (ModelValidationEngine engine, MClient client)
	{
		...
		engine.addModelChange(X_CC_AdministrativeDischarge.Table_Name, this);
	...
	public String modelChange (PO po, int type) throws Exception
	{
		...
		if((type == TYPE_BEFORE_NEW || type == TYPE_BEFORE_CHANGE) && po.get_Table_ID()==X_CC_AdministrativeDischarge.Table_ID) 
		{	
			...
			if(hosp.getDateInvited() != null && adm.getDate1() != null)
			{
				if(adm.getDate1().compareTo(hosp.getDateInvited()) < 0)
