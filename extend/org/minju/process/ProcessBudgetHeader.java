...
import org.compiere.model.X_GL_BudgetControlHeader;
 ...
 *	
 *  @author mfrojas
 *  @version $Id: ProcessBudgetHeader.java $
 */
//public class ProcessBudgetControl extends SvrProcess
public class ProcessBudgetHeader extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		if (p_budgetC_ID > 0)
		{
			X_GL_BudgetControlHeader budget = new X_GL_BudgetControlHeader(getCtx(), p_budgetC_ID, get_TrxName());
			...
			else if(budget.get_ValueAsString("DocStatus").compareTo("E3") == 0)
			{
				newStatus = "CO";
				newAction = "CO";
			}	
			...
			*/
			...
			if(cant > 0)
			{
				...
				else if(newAction.compareTo("CO") == 0)
				{
					...
					budget.set_CustomColumn("PrevsExp", "EX");
					budget.save();
