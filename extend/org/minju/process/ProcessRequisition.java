...
public class ProcessRequisition extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		if (p_Requisition_ID > 0)
		{
			 ...
			 * dependiendo del campo "MODE" de la solicitud de compra. Para distintas compras, se utilizará
			 * distintos estados. Pero todos llegan hasta el analista presupuesto.
			 * 
			 */
			
			//Para convenio marco y contrato de arrastre
			else if(req.getDocStatus().compareTo("AJ") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("CAR") == 0 || mode.compareTo("MAR") == 0))
			{
				newStatus = "AB";
				newAction = "AB";
			}
			else if(req.getDocStatus().compareTo("AB") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("CAR") == 0 || mode.compareTo("MAR") == 0))
			{
				newStatus = "GA";
				newAction = "GA";
			}	
			else if(req.getDocStatus().compareTo("GA") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("CAR") == 0 || mode.compareTo("MAR") == 0))
			{
				newStatus = "CO";
				newAction = "CO";
			}	
			...
			else if(req.getDocStatus().compareTo("AJ") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "AB";
				newAction = "AB";
			}
			
			else if(req.getDocStatus().compareTo("AB") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QA";
				newAction = "QA";
			}	
			else if(req.getDocStatus().compareTo("QA") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QB";
				newAction = "QB";
			}	
			else if(req.getDocStatus().compareTo("QB") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "AL";
				newAction = "AL";
			}	
			else if(req.getDocStatus().compareTo("AL") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QC";
				newAction = "QC";
			}	
			else if(req.getDocStatus().compareTo("QC") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QD";
				newAction = "QD";
			}	
			else if(req.getDocStatus().compareTo("QD") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "AX";
				newAction = "AX";
			}	
			else if(req.getDocStatus().compareTo("AX") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QE";
				newAction = "QE";
			}	
			else if(req.getDocStatus().compareTo("QE") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QF";
				newAction = "QF";
			}	
			else if(req.getDocStatus().compareTo("QF") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "Q8";
				newAction = "Q8";
			}	
			else if(req.getDocStatus().compareTo("Q8") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QH";
				newAction = "QH";
			}	
			else if(req.getDocStatus().compareTo("QH") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QO";
				newAction = "QO";
			}	
			else if(req.getDocStatus().compareTo("QO") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QI";
				newAction = "QI";
			}	
			else if(req.getDocStatus().compareTo("QI") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QJ";
				newAction = "QJ";
			}	
			else if(req.getDocStatus().compareTo("QJ") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QK";
				newAction = "QK";
			}	
			else if(req.getDocStatus().compareTo("QK") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QL";
				newAction = "QL";
			}	
			else if(req.getDocStatus().compareTo("QL") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "Q9";
				newAction = "Q9";
			}
			else if(req.getDocStatus().compareTo("Q9") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "Q0";
				newAction = "Q0";
			}	

			else if(req.getDocStatus().compareTo("Q0") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QN";
				newAction = "QN";
			}	
			else if(req.getDocStatus().compareTo("QN") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QU";
				newAction = "QU";
			}	
			else if(req.getDocStatus().compareTo("QU") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QP";
				newAction = "QP";
			}	
			else if(req.getDocStatus().compareTo("QP") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QQ";
				newAction = "QQ";
			}	
			else if(req.getDocStatus().compareTo("QQ") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QR";
				newAction = "QR";
			}	
			else if(req.getDocStatus().compareTo("QR") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QS";
				newAction = "QS";
			}	
			else if(req.getDocStatus().compareTo("QS") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "AM";
				newAction = "AM";
			}	
			else if(req.getDocStatus().compareTo("AM") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "QT";
				newAction = "QT";
			}	
			else if(req.getDocStatus().compareTo("QT") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("GC") == 0))
			{
				newStatus = "CO";
				newAction = "CO";
			}	
...
/*			else if(req.getDocStatus().compareTo("AB") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("LIB") == 0))
			{
				newStatus = "GA";
				newAction = "GA";
			}	
			else if(req.getDocStatus().compareTo("GA") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("LIB") == 0))
			{
				newStatus = "PP";
				newAction = "PP";
			}	

			else if(req.getDocStatus().compareTo("PP") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("LIB") == 0))
			{
				newStatus = "AL";
				newAction = "AL";
			}	
			else if(req.getDocStatus().compareTo("AL") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("LIB") == 0))
			{
				newStatus = "AA";
				newAction = "AA";
			}	
			else if(req.getDocStatus().compareTo("AA") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("LIB") == 0))
			{
				newStatus = "CO";
				newAction = "CO";
			}	
...
*/
			...
			else if(req.getDocStatus().compareTo("AJ") == 0 && p_Action.compareTo("CO") == 0 && mode.compareTo("DIR") == 0)
			{
				newStatus = "AB";
				newAction = "AB";
			}
			else if(req.getDocStatus().compareTo("AB") == 0 && p_Action.compareTo("CO") == 0 && mode.compareTo("DIR") == 0)
			{
				newStatus = "QA";
				newAction = "QA";
			}	
			else if(req.getDocStatus().compareTo("QA") == 0 && p_Action.compareTo("CO") == 0 && mode.compareTo("DIR") == 0)
			{
				newStatus = "QB";
				newAction = "QB";
			}	
			else if(req.getDocStatus().compareTo("QB") == 0 && p_Action.compareTo("CO") == 0 &&  mode.compareTo("DIR") == 0)
			{
				newStatus = "AL";
				newAction = "AL";
			}	
			else if(req.getDocStatus().compareTo("AL") == 0 && p_Action.compareTo("CO") == 0 &&  mode.compareTo("DIR") == 0)
			{
				newStatus = "QC";
				newAction = "QC";
			}
			else if(req.getDocStatus().compareTo("QC") == 0 && p_Action.compareTo("CO") == 0 &&  mode.compareTo("DIR") == 0)
			{
				newStatus = "QD";
				newAction = "QD";
			}
			else if(req.getDocStatus().compareTo("QD") == 0 && p_Action.compareTo("CO") == 0 &&  mode.compareTo("DIR") == 0)
			{
				newStatus = "AX";
				newAction = "AX";
			}
			else if(req.getDocStatus().compareTo("AX") == 0 && p_Action.compareTo("CO") == 0 &&  mode.compareTo("DIR") == 0)
			{
				newStatus = "QE";
				newAction = "QE";
			}
			else if(req.getDocStatus().compareTo("QE") == 0 && p_Action.compareTo("CO") == 0 &&  mode.compareTo("DIR") == 0)
			{
				newStatus = "CO";
				newAction = "CO";
			}
			...
			else if(req.getDocStatus().compareTo("AJ") == 0 && p_Action.compareTo("CO") == 0 && mode.compareTo("3ME") == 0)
			{
				newStatus = "AB";
				newAction = "AB";
			}
			else if(req.getDocStatus().compareTo("AB") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("3ME") == 0))
			{
				newStatus = "GA";
				newAction = "GA";
			}	
			else if(req.getDocStatus().compareTo("GA") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("3ME") == 0))
			{
				newStatus = "PP";
				newAction = "PP";
			}	
			else if(req.getDocStatus().compareTo("PP") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("3ME") == 0))
			{
				newStatus = "QV";
				newAction = "QV";
			}	
			else if(req.getDocStatus().compareTo("QV") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("3ME") == 0))
			{
				newStatus = "AR";
				newAction = "AR";
			}	
			else if(req.getDocStatus().compareTo("AR") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("3ME") == 0))
			{
				newStatus = "QB";
				newAction = "QB";
			}	
			else if(req.getDocStatus().compareTo("QB") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("3ME") == 0))
			{
				newStatus = "AL";
				newAction = "AL";
			}	
			else if(req.getDocStatus().compareTo("AL") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("3ME") == 0))
			{
				newStatus = "Q4";
				newAction = "Q4";
			}	
			else if(req.getDocStatus().compareTo("Q4") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("3ME") == 0))
			{
				newStatus = "AA";
				newAction = "AA";
			}	
			else if(req.getDocStatus().compareTo("AA") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("3ME") == 0))
			{
				newStatus = "QE";
				newAction = "QE";
			}	
			else if(req.getDocStatus().compareTo("QE") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("3ME") == 0))
			{
				newStatus = "CO";
				newAction = "CO";
			}	
			...
			else if(req.getDocStatus().compareTo("AJ") == 0 && p_Action.compareTo("CO") == 0 && mode.compareTo("ME3") == 0)
			{
				newStatus = "AB";
				newAction = "AB";
			}
			else if(req.getDocStatus().compareTo("AB") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("ME3") == 0))
			{
				newStatus = "GA";
				newAction = "GA";
			}	
			else if(req.getDocStatus().compareTo("GA") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("ME3") == 0))
			{
				newStatus = "PP";
				newAction = "PP";
			}	
			else if(req.getDocStatus().compareTo("PP") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("ME3") == 0))
			{
				newStatus = "QV";
				newAction = "QV";
			}	
			else if(req.getDocStatus().compareTo("QV") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("ME3") == 0))
			{
				newStatus = "AR";
				newAction = "AR";
			}	
			else if(req.getDocStatus().compareTo("AR") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("ME3") == 0))
			{
				newStatus = "AA";
				newAction = "AA";
			}	
			else if(req.getDocStatus().compareTo("AA") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("ME3") == 0))
			{
				newStatus = "QE";
				newAction = "QE";
			}	
			else if(req.getDocStatus().compareTo("QE") == 0 && p_Action.compareTo("CO") == 0 && (mode.compareTo("ME3") == 0))
			{
				newStatus = "CO";
				newAction = "CO";
			}	
			...
			if(cant > 0)
			{
				if(newAction.compareTo("CO") != 0)
				{
					...
					else if(newAction.compareTo("GA")==0)
					{
						...
						if(mode.compareTo("CAR") == 0 && hascontract.compareTo("true") == 0)
							cst.setInt(2, 40);
						else
							cst.setInt(2, 12);
						cst.setString(3, "-");
