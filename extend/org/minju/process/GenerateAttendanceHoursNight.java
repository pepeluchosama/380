 ...
 *	
 *  @author mfrojas
 *  @version $Id: GenerateAttendanceHoursNight.java $
 */
public class GenerateAttendanceHoursNight extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		if (p_From != null && p_To != null)
		{
			...
			String sqlfrom = "SELECT (current_date - cast('1 day' as interval))::timestamp as default from dual where 1 = ? ";
			Timestamp actual = DB.getSQLValueTS(get_TrxName(), sqlfrom, 1 );
			p_From = actual;
			p_To = actual;
			...
			//mfrojas cambio de modelo en proceso de horas nocturnas. Se generara la vista por cbpartner, y no para todos altiro.
