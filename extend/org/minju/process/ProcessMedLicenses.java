...
public class ProcessMedLicenses extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		if (p_RH_MLicenses > 0)
		{
			...
			if(med.getDocStatus().compareTo("DR")==0 && (role_ID != 2000017 && role_ID != 2000042))
				throw new AdempiereException("Rol No Puede Procesar Documento");
			if(med.getDocStatus().compareTo("VA")==0 && (role_ID != 2000018 && role_ID != 2000043))
				throw new AdempiereException("Rol No Puede Procesar Documento");
			if(p_DocStatus.compareToIgnoreCase("EA")==0 && (role_ID != 2000017 && role_ID != 2000042))
				throw new AdempiereException("Rol No Puede Procesar Documento");
			//if(p_DocStatus.compareToIgnoreCase("CO")==0 && role_ID != 2000018)
			//	throw new AdempiereException("Rol No Puede Procesar Documento");
			if(med.getDocStatus().compareTo("RE")==0 && (role_ID != 2000017  && role_ID != 2000042))
				throw new AdempiereException("Rol No Puede Procesar Documento");			
