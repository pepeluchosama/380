 ...
 */
public class ModMINJUBGHistory implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModMINJUBGHistory ()
	{
		super ();
	}	//	MyValidator
	...
	public void initialize (ModelValidationEngine engine, MClient client)
	{
		...
		engine.addModelChange(X_DM_PerformanceBond.Table_Name, this);		
	...
	public String modelChange (PO po, int type) throws Exception
	{
		...
		if(type == TYPE_BEFORE_CHANGE && po.get_Table_ID()==X_DM_PerformanceBond.Table_ID
				&& po.is_ValueChanged("DocStatus")) 
		{	
			X_DM_PerformanceBond doc = (X_DM_PerformanceBond)po;
			//solo boleta de garantia
