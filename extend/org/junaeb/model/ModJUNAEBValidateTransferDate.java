 ...
 *  @author mfrojas
 */
public class ModJUNAEBValidateTransferDate implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModJUNAEBValidateTransferDate ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModJUNAEBValidateTransferDate.class);
	/** Client			*/
	...
	public String modelChange (PO po, int type) throws Exception
	{
		...
		{	
			...
			if(doctype_id == 1000009 || doctype_id == 1000003)
			{
