 ...
 *  @author mfrojas
 */
public class ModMOPValidateAmtInvoiceLine implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModMOPValidateAmtInvoiceLine ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModMOPValidateAmtInvoiceLine.class);
	/** Client			*/
