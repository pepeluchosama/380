 ...
 *  @author mfrojas
 */
public class ModMOPValidateUpdateAsset implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModMOPValidateUpdateAsset ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModMOPValidateUpdateAsset.class);
	/** Client			*/
	...
	public String modelChange (PO po, int type) throws Exception
	{
		...
		{	
			...
			if(typemov.compareTo("MOD")==0)
			{
				...
				if(doctype_id == 2000169 && assetsituation.compareTo("BAJ") != 0)
					return "Las reactivaciones son solo para bienes de baja";
				else if(doctype_id != 2000169 && assetsituation.compareTo("BAJ") == 0)
