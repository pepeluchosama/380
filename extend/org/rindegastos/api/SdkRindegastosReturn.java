...
public class SdkRindegastosReturn {
    
    private String token = "";

    public SdkRindegastosReturn(String t) {
        //constructor
    ...
    public String getExpenses(HashMap<String, String> paramsGetExpenses)  throws MalformedURLException, IOException  { //metodo que consume el servicio getExpense
    ...
    public String getExpenseReports(HashMap<String, String> paramsGetExpenseReports)  throws MalformedURLException, IOException  { //metodo que consume el servicio getExpense
    ...
    public String getExpensePolicies(HashMap<String, String> paramsGetExpensePolicies)  throws MalformedURLException, IOException  { //metodo que consume el servicio getExpense
    ...
    public String getUsers(HashMap<String, String> paramsGetUsers)  throws MalformedURLException, IOException  { //metodo que consume el servicio getExpense
