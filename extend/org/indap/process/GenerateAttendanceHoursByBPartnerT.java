 ...
 */
public class GenerateAttendanceHoursByBPartnerT extends SvrProcess
{
		...
		if (p_From != null && p_To != null)
		{
			...
			while(rs2.next())
			{
				String sqlgethours = "SELECT fecha, ad_org_id, c_bpartner_id, dia, entrada, salida, horas_trabajadas, " +
					" incidencias, compensadas, atrasobase, horasmediamannana FROM OFB_Reloj_Control WHERE fecha " +
					" between '"+p_From+"' AND '"+p_To+"'";
