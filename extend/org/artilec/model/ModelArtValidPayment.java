...
/**
 *	Validator for company artilec
 *
 *  @author Julio Farias
 */
public class ModelArtValidPayment implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModelArtValidPayment ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModelArtValidPayment.class);
	/** Client			*/
