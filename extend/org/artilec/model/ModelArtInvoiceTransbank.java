 ...
 */
public class ModelArtInvoiceTransbank implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModelArtInvoiceTransbank ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModelArtInvoiceTransbank.class);
	/** Client			*/
