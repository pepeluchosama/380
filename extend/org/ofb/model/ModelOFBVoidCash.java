 ...
 */
public class ModelOFBVoidCash implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModelOFBVoidCash ()
	{
		super ();
	}	//	MyValidator
	...
	public String docValidate (PO po, int timing)
	{
		...
		if (timing == TIMING_BEFORE_VOID && po.get_Table_ID() == MCash.Table_ID)			
		{
			MCash cash = (MCash) po;
			...
			for (int i = 0; i < lines.length; i++)
			{
				...
				{
					//si existe pago completo asociado no deja anular
					if(line.getC_Payment().getDocStatus().compareTo("CO") == 0
							|| line.getC_Payment().getDocStatus().compareTo("CL") == 0)
