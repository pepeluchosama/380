 ...
 */
public class ModelOFBAmtRequisition implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModelOFBAmtRequisition ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModelOFBAmtRequisition.class);
	/** Client			*/
	...
	public String docValidate (PO po, int timing)
	{
		...
		if(timing == TIMING_BEFORE_COMPLETE && po.get_Table_ID()==MRequisition.Table_ID)
		{
			...
			if(req.getC_DocType().getDocBaseType().compareToIgnoreCase("POR") == 0)
			{
