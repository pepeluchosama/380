...
public class CalloutOrder extends CalloutEngine
{
	...
	public String docType (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		try
		{
			...
			if (rs.next())		//	we found document type
			{
				...
				//	Delivery Rule
				//ININOLES se modifica logica para que permita seleccionar como predeterminado cualquier 
				// Delivery Rule
				/*if (DocSubTypeSO.equals(MOrder.DocSubTypeSO_POS))
					mTab.setValue ("DeliveryRule", X_C_Order.DELIVERYRULE_Force);
				if (DocSubTypeSO.equals(MOrder.DocSubTypeSO_Prepay))
	...
	public String amt (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		//	Product Qty changed - recalc price
					...
					(
					 mField.getColumnName().equals("QtyOrdered") || 
				...
				)
		{
			...
			//ININOLES no se cambiara precio cuando se cambie la cantidad y el precio sea distinto de 0
