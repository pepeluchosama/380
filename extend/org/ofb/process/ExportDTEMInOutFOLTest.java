 ...
 */
public class ExportDTEMInOutFOLTest extends SvrProcess
{
	/** Properties						*/
	...
	public String CreateXMLCG(MInOut inOut)
    {
        ...
        try
        {
          ...
          //ininoles indicaciones traslado
            ...
            {
	            Element CmnaRecep = document.createElement("CmnaRecep");
	            org.w3c.dom.Text Cmna = document.createTextNode(MCity.get(inOut.getCtx(), bloc.getLocation(true).getC_City_ID()).getName());
	            CmnaRecep.appendChild(Cmna);
	            Receptor.appendChild(CmnaRecep);
            }
            else if (bloc.getLocation(true).getAddress3() != null && bloc.getLocation(true).getAddress3().length() > 1) 
            {
            	Element CmnaRecep = document.createElement("CmnaRecep");
	            org.w3c.dom.Text Cmna = document.createTextNode(bloc.getLocation(true).getAddress3());
	            CmnaRecep.appendChild(Cmna);
	            Receptor.appendChild(CmnaRecep);
            }
            else
