 ...
 */
public class InOutGenerateOFBValidDateLine extends SvrProcess
{
	/**	Manual Selection		*/
	...
	{
		//se fuerza que sean distintas ubicaciones
		//p_ConsolidateDocument = false;
	...
	private String generate (PreparedStatement pstmt)
	{
		...
		try
		{
			...
			while (rs.next ())		//	Order
			{
				...
				//ininoles se setea fecha prometida como hoy
				p_DatePromised = new Timestamp(System.currentTimeMillis());
