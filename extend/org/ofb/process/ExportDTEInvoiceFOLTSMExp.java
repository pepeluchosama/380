 ...
 */
public class ExportDTEInvoiceFOLTSMExp extends SvrProcess
{	
	/** Properties						*/
	...
	public String CreateXMLCG(MInvoice invoice)
    {
        ...
        try
        {
            ...
            Timestamp fchEmisTSM = (Timestamp)invoice.get_Value("DueDateTSM");
            //ininoles nueva fecha de emision
            //org.w3c.dom.Text emis = document.createTextNode(invoice.getDateInvoiced().toString().substring(0, 10));
            org.w3c.dom.Text emis = document.createTextNode(fchEmisTSM.toString().substring(0, 10));
            ...
            if(invoice.getPOReference() != null && invoice.getPOReference().length() > 0)//referencia orden
            {
                 ...
                 if((Timestamp)invoice.get_Value("DueDateTSM") != null)
                	 dateOrdTxt = ((Timestamp)invoice.get_Value("DueDateTSM")).toString().substring(0, 10);
                 else if(invoice.getDateOrdered() == null)
