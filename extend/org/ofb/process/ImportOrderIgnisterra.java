 ...
 */
public class ImportOrderIgnisterra extends SvrProcess
{
		...
		**/
		...
		try
		{
			...
			while (rs.next ())
			{
				...
				//se agregan atributos ininoles				
				MAttributeSetInstance att = new MAttributeSetInstance(getCtx(), 0, 
						1000006, get_TrxName());
				att.save();
				
				MAttributeInstance at1 = new MAttributeInstance(getCtx(), 1000014, 
						att.getM_AttributeSetInstance_ID(), imp.get_ValueAsString("PAtr1"), get_TrxName()); // atributo 1
				at1.save();
				MAttributeInstance at2 = new MAttributeInstance(getCtx(), 1000015, 
						att.getM_AttributeSetInstance_ID(), imp.get_ValueAsString("PAtr2"), get_TrxName()); // atributo 2
				at2.save();
				MAttributeInstance at3 = new MAttributeInstance(getCtx(), 1000016, 
						att.getM_AttributeSetInstance_ID(), imp.get_ValueAsString("PAtr3"), get_TrxName()); // atributo 3
				at3.save();
				MAttributeInstance at4 = new MAttributeInstance(getCtx(), 1000017, 
						att.getM_AttributeSetInstance_ID(), imp.get_ValueAsString("PAtr4"), get_TrxName()); // atributo 4
				at4.save();
				MAttributeInstance at5 = new MAttributeInstance(getCtx(), 1000018, 
						att.getM_AttributeSetInstance_ID(), imp.get_ValueAsString("PAtr5"), get_TrxName()); // atributo 5
				at5.save();
				MAttributeInstance at6 = new MAttributeInstance(getCtx(), 1000019, 
						att.getM_AttributeSetInstance_ID(), imp.get_ValueAsString("PAtr6"), get_TrxName()); // atributo 6
				at6.save();
