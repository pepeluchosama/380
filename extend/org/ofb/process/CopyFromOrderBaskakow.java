 ...
 */
public class CopyFromOrderBaskakow extends SvrProcess
{
	/**	The Order				*/
	...
	protected String doIt() throws Exception
	{
		...
		//ininoles, se setea campo desde donde se copian las lineas
		to.set_CustomColumn("C_OrderRef_ID", p_C_Order_ID);
		//Se copia direccion.		
