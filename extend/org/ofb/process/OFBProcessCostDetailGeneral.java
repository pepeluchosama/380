 ...
 */
public class OFBProcessCostDetailGeneral extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		*/
		...
		//mfrojas 20210819
		//El proceso buscara entre todos los productos que tienen algun costdetail en processed='N'
		long inicio;
		long fin;
		
		inicio = System.currentTimeMillis();
		String sql = "SELECT distinct(m_product_id) from m_costdetail WHERE processed='N' and ad_Client_id = "+Env.getAD_Client_ID(getCtx());
		...
		while(rs.next())
		{
			MInOutLine ml = new MInOutLine(getCtx(), rs.getInt("M_Product_ID"),get_TrxName());
