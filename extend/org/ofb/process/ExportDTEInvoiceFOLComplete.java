 ...
 */
public class ExportDTEInvoiceFOLComplete extends SvrProcess
{	
	/** Properties						*/
          ...
          //ininoles nuevos campos de termino de pago
            ...
            if(tipo_Ref>0)
            {
                ...
                if(codRef != null && codRef.trim().length() > 0)
                {
	                ...
	                org.w3c.dom.Text codref = document.createTextNode(codRef);
	                CodRef.appendChild(codref);
	                Referencia.appendChild(CodRef);
                }
                indice = indice+1;
            }
            //ininoles nueva referencia HES
            ...
            if (hesTxt != null && hesTxt.trim().length() > 0)
            {
                ...
                org.w3c.dom.Text Nro2 = document.createTextNode(Integer.toString(indice));
                ...
                org.w3c.dom.Text ref2 = document.createTextNode(hesTxt);
                ...
                if(dateHesTxt != null)
                {
	                ...
	                org.w3c.dom.Text fchref2 = document.createTextNode(dateHesTxt.toString().substring(0, 10));
