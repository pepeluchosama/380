 ...
 */
public class ExportDTEInvoiceFOLBoleta extends SvrProcess
{	
	/** Properties						*/
        ...
        try
        {
          ...
          //ininoles nueva referencia de guia de despacho
            ...
            try            	
            {
            	...
            	{
            		ID_Ship = DB.getSQLValue(get_TrxName(), "SELECT COALESCE((MAX(M_InOut_ID)),0) " +
            ...
            if(ID_Ship>0)
            {
            	...
            	MDocType docTShip = new MDocType(getCtx(), inOutref.getC_DocType_ID(), get_TrxName());
