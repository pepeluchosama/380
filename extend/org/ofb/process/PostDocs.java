...
public class PostDocs extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		//  SELECT * FROM table
			...
			.append(",").append(ReturnIssoTrx(TableName)).append(",").append(ReturnTableSec(TableName)).append(",created")
	...
	private int ReturnTableSec(String tableName)
	{
		if(tableName.toLowerCase().compareToIgnoreCase("M_InOut") == 0)
			return 50;
		if(tableName.toLowerCase().compareToIgnoreCase("C_Invoice") == 0)
			return 60;
		return 100;
	}
	private String ReturnIssoTrx(String tableName)
	{
		if(tableName.toLowerCase().compareToIgnoreCase("M_InOut") == 0)
			return "IssoTrx";		
		return "'N'";
