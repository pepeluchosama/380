 ...
 */
public class ExportDTEInvoiceFOL2Clinica21Linea extends SvrProcess
{	
	/** Properties						*/
    ...
    {	
        ...
        try
        {
          ...
          //ininoles nuevos campos de termino de pago
            ...
            org.w3c.dom.Text qt = document.createTextNode(Env.ONE.toString());
            QtyItem.appendChild(qt);
            Detalle.appendChild(QtyItem);
                                
            String unmdItemStr = "UN";            
            ...
            org.w3c.dom.Text pa = document.createTextNode(invoice.getTotalLines().setScale(0, 4).toString());
            PrcItem.appendChild(pa);
            Detalle.appendChild(PrcItem);
            
            Element MontoItem = document.createElement("MontoItem");
            org.w3c.dom.Text tl = document.createTextNode(invoice.getTotalLines().setScale(0, 4).toString());
