 ...
 */
public class ExportDTEInvoiceCGGem extends SvrProcess
{
	/** Properties						*/
	...
	public String CreateXMLCG(MInvoice invoice)
    {
        ...
        try
        {
          ...
          /*  MPaymentTerm pterm = new MPaymentTerm(invoice.getCtx(), invoice.getC_PaymentTerm_ID(), invoice.get_TrxName());
            ...
            org.w3c.dom.Text corrRecep = document.createTextNode(invoice.getAD_User_ID()>0?invoice.getAD_User().getEMail():" "); //nombre completo contacto
    		...
    		try
    		{
    			...
    			while (rs.next())
    			{
                    ...
                    if (rs.getString("OTHER_INFO_3") != null )
                    {
                  ...
                  //ininoles SKUIN geminis
                    if (rs.getString("OTHER_INFO_1") != null )
                    {
            ...
            if(tipo_Ref>0){
               ...
               /* Element RUTOtr = document.createElement("RUTOtr");
                ...
                if (docNoRef != null)
                {
                    ...
                    org.w3c.dom.Text ref2 = document.createTextNode(invoice.get_ValueAsString("Ref_Codigo_Cliente_CC")==null?" ":invoice.get_ValueAsString("Ref_Codigo_Cliente_CC"));
                    FolioRef2.appendChild(ref2);
                    Referencia2.appendChild(FolioRef2);
                    //end ininoles
                                      
                    Element FchRef2 = document.createElement("FchRef");
                    org.w3c.dom.Text fchref2 = document.createTextNode(fechareferencia==null?" ":fechareferencia);
                    FchRef2.appendChild(fchref2);
                    Referencia2.appendChild(FchRef2);
                    
                    //ininoles nuevo campo
                    Element RazonRef22 = document.createElement("RazonRef");                    
                    org.w3c.dom.Text Rref2 = document.createTextNode(invoice.get_ValueAsString("Ref_Nombre_Cliente_CC")==null?" ":invoice.get_ValueAsString("Ref_Nombre_Cliente_CC"));
                    FolioRef2.appendChild(Rref2);
                    Referencia2.appendChild(RazonRef22);
                    //end ininoles
                    
                    Element CodRef2 = document.createElement("CodRef");
                    org.w3c.dom.Text codref2 = document.createTextNode(invoice.get_ValueAsString("CodRef")==null?" ":invoice.get_ValueAsString("CodRef"));
        ...
        return "XML CG GEMINIS Generated";
    }	
}	//	InvoiceCreateInOut
