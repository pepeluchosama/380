 ...
 */
public class ExportDTEInvoiceFOLArtilec extends SvrProcess
{	
	/** Properties						*/
    ...
    {	
        ...
        try
        {
          ...
          //ininoles nuevos campos de termino de pago
            ...
            //nuevos campos de direccion para artilec
            ...
            {	
            	...
            	if(iLine.getTaxAmt().compareTo(Env.ZERO) >=0)
            	{
	                ...
	                */
	                ...
	                //ininoles la descripcion solo sera si no es nota de credito
            	...
            	else
            	{
	                ...
	                org.w3c.dom.Text line = document.createTextNode(Integer.toString(lineDiscount));
	                NroLinDR.appendChild(line);
	                DscRcgGlobal.appendChild(NroLinDR);
	                
	                Element TpoMov = document.createElement("TpoMov");
	                org.w3c.dom.Text lineTpoMov = document.createTextNode("D");
	                TpoMov.appendChild(lineTpoMov);
	                ...
	                pname = pname.replace("\"", "");
	                org.w3c.dom.Text Item = document.createTextNode(pname);
	                GlosaDR.appendChild(Item);
	                DscRcgGlobal.appendChild(GlosaDR);
	                
	                Element TpoValor = document.createElement("TpoValor");
	                org.w3c.dom.Text lineTpoValor = document.createTextNode("$");
	                TpoValor.appendChild(lineTpoValor);
	                DscRcgGlobal.appendChild(TpoValor);
	                
	                Element MontoItem = document.createElement("ValorDR");
	                org.w3c.dom.Text tl = document.createTextNode(iLine.getLineNetAmt().abs().setScale(0, 4).toString());
	                MontoItem.appendChild(tl);
	                DscRcgGlobal.appendChild(MontoItem);
            	}
            }            
            mylog = "referencia";
        ...
        try
        {
          ...
          //ininoles calculo de fecha de vencimiento
            ...
            {	
            	...
            	if(iLine.getM_Product_ID()==0 && iLine.getC_Charge_ID()==0)
            		continue;    
            	//se comenta cpdigo y se copia de metodo CreateXMLCG para agregar descuento en boletas ininoles 
                /*Element Detalle = document.createElement("Detalle");
                Documento.appendChild(Detalle);*/
