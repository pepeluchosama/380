 ...
 */
public class Mod_TSM_ValidacionKmFechaVolumen implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public Mod_TSM_ValidacionKmFechaVolumen ()
	{
		super ();
	}	//	MyValidator
	...
	public String modelChange (PO po, int type) throws Exception
	{
		...
		/* se sacan validaciones de detalle para manejarlas por separado
