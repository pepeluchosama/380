 ...
 */
public class Mod_TSM_ChequeoDestinoEnFlota implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public Mod_TSM_ChequeoDestinoEnFlota ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(Mod_TSM_ChequeoDestinoEnFlota.class);
	/** Client			*/
