 ...
 */
public class ModelTSMAmtRequisition implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModelTSMAmtRequisition ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModelTSMAmtRequisition.class);
	/** Client			*/
