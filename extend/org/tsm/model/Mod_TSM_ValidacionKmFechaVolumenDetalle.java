 ...
 */
public class Mod_TSM_ValidacionKmFechaVolumenDetalle implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public Mod_TSM_ValidacionKmFechaVolumenDetalle ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(Mod_TSM_ValidacionKmFechaVolumenDetalle.class);
	/** Client			*/
