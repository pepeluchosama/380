 ...
 */
public class Mod_TSM_ValidacionCabKm implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public Mod_TSM_ValidacionCabKm ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(Mod_TSM_ValidacionCabKm.class);
	/** Client			*/
