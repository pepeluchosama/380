 ...
 */
public class Mod_TSM_ValidacionCabFecha implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public Mod_TSM_ValidacionCabFecha ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(Mod_TSM_ValidacionCabFecha.class);
	/** Client			*/
	...
	public void initialize (ModelValidationEngine engine, MClient client)
	{
		...
		//Ininoles solo seran validaciones cabecera
	...
	public String modelChange (PO po, int type) throws Exception
	{
		...
		if((type == TYPE_BEFORE_NEW || type == TYPE_BEFORE_CHANGE) && po.get_Table_ID()==X_M_Movement.Table_ID)//cabecera hr
		{
