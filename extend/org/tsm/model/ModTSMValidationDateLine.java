 ...
 */
public class ModTSMValidationDateLine implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModTSMValidationDateLine ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModTSMValidationDateLine.class);
	/** Client			*/
	...
	public String modelChange (PO po, int type) throws Exception
	{
		...
		{
			MMovementLine mml = (MMovementLine) po;			
			...
			if(inicio != null && inicio.getYear() != now.getYear())
				return "Error: Ingresar fecha de año actual";
			if(termino != null && termino.getYear() != now.getYear())
				return "Error: Ingresar fecha de año actual";	
		}
	return null;
	}	//	modelChange
