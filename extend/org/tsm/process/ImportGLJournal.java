		...
		try
		{
			...
			while (rs.next())
			{
				...
				try{
					...
					//nueva linea de fecha de vencimiento ininoles
					line.set_ValueOfColumn("DateTrx", imp.get_Value("DateTrx"));
					if(imp.get_ValueAsInt("A_Asset_ID") > 0)
						line.set_ValueOfColumn("A_Asset_ID",imp.get_ValueAsInt("A_Asset_ID"));
					}
				catch(Exception e){}
