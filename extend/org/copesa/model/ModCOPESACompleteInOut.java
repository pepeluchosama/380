 ...
 */
public class ModCOPESACompleteInOut implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModCOPESACompleteInOut ()
	{
		super ();
	}	//	MyValidator
	...
	public String modelChange (PO po, int type) throws Exception
	{
		...
		if(type == TYPE_BEFORE_CHANGE && po.get_Table_ID()==MInOut.Table_ID && po.is_ValueChanged("DocStatus") ) 
		{	
			MInOut io = (MInOut)po;
			if( io.getDocStatus().compareToIgnoreCase("CO") == 0 )
			{
				Timestamp dt = DB.getSQLValueTS(io.get_TrxName(), "select now()", (Object[])null);
