 ...
 */
public class ModCOPESAValidPaymentRule implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModCOPESAValidPaymentRule ()
	{
		super ();
	}	//	MyValidator
		...
		if(timing == TIMING_BEFORE_COMPLETE && po.get_Table_ID()==MOrder.Table_ID)
		{
			...
			if(order.isSOTrx())
			{
						...
						&& pList.get_ValueAsString("PaymentRule") != "" && pList.get_ValueAsString("PaymentRule") != " ")
				{
					...
					{
						String namePRule = DB.getSQLValueString(po.get_TrxName(), "SELECT rlt.NAME " +
								" FROM AD_Ref_List rl " +
