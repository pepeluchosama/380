 ...
 */
public class ModCOPESAUpdateDateOLinePAT implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModCOPESAUpdateDateOLinePAT ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModCOPESAUpdateDateOLinePAT.class);
	/** Client			*/
