 ...
 */
public class ModCOPESAValidPLLevel implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModCOPESAValidPLLevel ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModCOPESAValidPLLevel.class);
	/** Client			*/
	...
	public String docValidate (PO po, int timing)
	{
		...
		if(timing == TIMING_BEFORE_COMPLETE && po.get_Table_ID()==MOrder.Table_ID)
		{
			...
			if(order.isSOTrx())
			{
				...
				if(cant < cantLinePL)
					return "ERROR: Pedido debe incluir al menos "+pList+
